...
import com.kppmining.client.databinding.ActivityAdministrationAndSelectionSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class AdministrationAndSelectionSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAdministrationAndSelectionSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityAdministrationAndSelectionSimperBinding.inflate(layoutInflater)
