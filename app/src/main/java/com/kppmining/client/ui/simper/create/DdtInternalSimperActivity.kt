...
import com.kppmining.client.databinding.ActivityDdtInternalSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class DdtInternalSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityDdtInternalSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityDdtInternalSimperBinding.inflate(layoutInflater)
