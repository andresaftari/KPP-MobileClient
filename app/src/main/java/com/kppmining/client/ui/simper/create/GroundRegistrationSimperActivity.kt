...
import com.kppmining.client.databinding.ActivityGroundRegistrationSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class GroundRegistrationSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGroundRegistrationSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGroundRegistrationSimperBinding.inflate(layoutInflater)
