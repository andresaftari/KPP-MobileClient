...
import com.kppmining.client.databinding.ActivityGroundTestResultCheckSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class GroundTestResultCheckSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityGroundTestResultCheckSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityGroundTestResultCheckSimperBinding.inflate(layoutInflater)
