...
import com.kppmining.client.databinding.ActivityMcuValidationSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class McuValidationSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityMcuValidationSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityMcuValidationSimperBinding.inflate(layoutInflater)
