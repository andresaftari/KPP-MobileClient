...
import com.kppmining.client.databinding.ActivityOrientationProcessingSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class OrientationProcessingSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityOrientationProcessingSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOrientationProcessingSimperBinding.inflate(layoutInflater)
