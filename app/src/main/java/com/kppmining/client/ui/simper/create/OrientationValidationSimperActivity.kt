...
import com.kppmining.client.databinding.ActivityOrientationValidationSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class OrientationValidationSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityOrientationValidationSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityOrientationValidationSimperBinding.inflate(layoutInflater)
