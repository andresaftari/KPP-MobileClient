...
import com.kppmining.client.databinding.ActivityReleasingSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class ReleasingSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityReleasingSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityReleasingSimperBinding.inflate(layoutInflater)
