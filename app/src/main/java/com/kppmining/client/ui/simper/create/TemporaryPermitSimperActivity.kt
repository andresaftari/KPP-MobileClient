...
import com.kppmining.client.databinding.ActivityTemporaryPermitSimperBinding
import com.kppmining.core.domain.model.DummyAccount

class TemporaryPermitSimperActivity : AppCompatActivity() {
    private lateinit var binding: ActivityTemporaryPermitSimperBinding

    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityTemporaryPermitSimperBinding.inflate(layoutInflater)
