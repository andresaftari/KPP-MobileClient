...
import com.kppmining.client.databinding.ActivitySimperAdministrationSelectionBinding
import com.kppmining.core.domain.model.DummyAccount

class SimperAdministrationSelectionActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperAdministrationSelectionBinding
    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimperAdministrationSelectionBinding.inflate(layoutInflater)
