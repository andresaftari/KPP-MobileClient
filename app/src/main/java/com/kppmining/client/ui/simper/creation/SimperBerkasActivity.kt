...
import com.kppmining.client.databinding.ActivitySimperBerkasBinding
...
class SimperBerkasActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperBerkasBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySimperBerkasBinding.inflate(layoutInflater)
