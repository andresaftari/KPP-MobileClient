...
import com.kppmining.client.databinding.ActivitySimperGroundTestBinding
import com.kppmining.core.domain.model.DummyAccount

class SimperGroundTestActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperGroundTestBinding
    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimperGroundTestBinding.inflate(layoutInflater)
