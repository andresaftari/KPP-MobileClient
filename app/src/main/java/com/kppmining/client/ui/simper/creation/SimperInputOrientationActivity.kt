...
import com.kppmining.client.databinding.ActivitySimperInputOrientationBinding
...
class SimperInputOrientationActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperInputOrientationBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivitySimperInputOrientationBinding.inflate(layoutInflater)
    ...
    private fun startDialog() {
        ...
        MaterialAlertDialogBuilder(this)
            ...
            .setPositiveButton("Okay") { dialog, _ ->
                ...
                startActivity(
                    Intent(
                        this, SimperValidationActivity::class.java
