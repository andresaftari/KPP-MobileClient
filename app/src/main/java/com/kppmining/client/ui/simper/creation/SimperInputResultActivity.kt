...
import com.kppmining.client.databinding.ActivitySimperInputResultBinding
import com.kppmining.core.domain.model.DummyAccount

class SimperInputResultActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperInputResultBinding
    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimperInputResultBinding.inflate(layoutInflater)
