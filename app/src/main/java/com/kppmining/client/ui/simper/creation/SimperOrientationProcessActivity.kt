...
import com.kppmining.client.databinding.ActivitySimperOrientationProcessBinding
import com.kppmining.core.domain.model.DummyAccount

class SimperOrientationProcessActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperOrientationProcessBinding
    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimperOrientationProcessBinding.inflate(layoutInflater)
