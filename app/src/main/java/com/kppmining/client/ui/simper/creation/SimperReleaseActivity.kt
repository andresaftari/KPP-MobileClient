...
import com.kppmining.client.databinding.ActivitySimperReleaseBinding
import com.kppmining.core.domain.model.DummyAccount

class SimperReleaseActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperReleaseBinding
    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimperReleaseBinding.inflate(layoutInflater)
