...
import com.kppmining.client.databinding.ActivitySimperSelectionBinding
import com.kppmining.core.domain.model.DummyAccount

class SimperSelectionActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperSelectionBinding
    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimperSelectionBinding.inflate(layoutInflater)
