...
import com.kppmining.client.databinding.ActivitySimperTempPermitBinding
import com.kppmining.core.domain.model.DummyAccount

class SimperTempPermitActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperTempPermitBinding
    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimperTempPermitBinding.inflate(layoutInflater)
