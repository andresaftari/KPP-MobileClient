...
import com.kppmining.client.databinding.ActivitySimperValidationBinding
import com.kppmining.core.domain.model.DummyAccount

class SimperValidationActivity : AppCompatActivity() {
    private lateinit var binding: ActivitySimperValidationBinding
    private var account = DummyAccount()

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivitySimperValidationBinding.inflate(layoutInflater)
